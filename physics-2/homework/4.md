...
6.
    ...
    1.
        $$\vec{E} = k(xy\hat{x} + yz\hat{y} + xz\hat{z})$$
        $$\Downarrow$$
        $$(k(xy\hat{x} + yz\hat{y} + xz\hat{z}))\times (\frac{\delta }{\delta x}\hat{x} + \frac{\delta }{\delta y}\hat{y} + \frac{\delta }{\delta z}\hat{z})$$
        $$k[(xy\hat{x} + yz\hat{y} + xz\hat{z})\times (\frac{\delta }{\delta x}\hat{x} + \frac{\delta }{\delta y}\hat{y} + \frac{\delta }{\delta z}\hat{z})]$$
        $$k[
            (\frac{\delta }{\delta z}yz - \frac{\delta }{\delta y}xz)\hat{x}
            (\frac{\delta }{\delta x}xz - \frac{\delta }{\delta z}xy)\hat{y}
            (\frac{\delta }{\delta y}xy - \frac{\delta }{\delta x}yz)\hat{z}]$$
    2.
        $$\vec{E} = k(y^2\hat{x} + (2xy+z^2)\hat{z} + 2yz\hat{z})$$
